...
function ft_settings_external_load() {
  ...
  define("USERNAME", "upload"); // Your default username.
  define("PASSWORD", "123456789"); // Your default password.
  ...
  $ft["settings"]["MAXSIZE"]           = 102400000; // Maximum file upload size - in bytes.
